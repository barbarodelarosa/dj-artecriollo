# Generated by Django 4.0.2 on 2022-02-18 17:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avialable_colours', models.ManyToManyField(to='cart.ColorVariation')),
                ('avialable_sizes', models.ManyToManyField(to='cart.SizeVariation')),
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cart.brand')),
                ('category', models.ManyToManyField(to='cart.Category')),
                ('tag', models.ManyToManyField(to='cart.Tag')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.IntegerField(default=0)),
                ('colour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.colorvariation')),
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.materialvariation')),
                ...
                ('shop', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cart.shop')),
