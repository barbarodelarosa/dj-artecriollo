    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avialable_colours', models.ManyToManyField(to='shop.ColorVariation')),
            ],
        ),
        migrations.CreateModel(
            name='Shop',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_image_content', to='shop.product')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='shop.SizeVariation'),
        ),
        migrations.AddField(
            model_name='product',
            name='brand',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.IntegerField(default=0)),
                ('stock', models.PositiveIntegerField(default=0)),
                ('colour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.colorvariation')),
