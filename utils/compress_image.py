...
def compress_img(image_name, new_size_ratio=0.9, quality=90, width=None, height=None, to_jpg=True):
    ...
    if to_jpg:
        ...
        new_filename = "{}_compressed.jpg".format(filename)
    else:
        # retain the same extension of the original image
        new_filename = "{}_compressed{}".format(filename,ext)
    try:
    ...
    diferent_size = "[+] Image size change: {:.2f}% of the original image size.".format(saving_diff/image_size*100)
    print(diferent_size)
