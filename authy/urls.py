...
from authy.views import UserProfile, Signup, PasswordChange, PasswordChangeDone, EditProfile, addOrRemoveToWhishList, addToList, PeopleListView, ListPeopleDelete
# ShowList, 
